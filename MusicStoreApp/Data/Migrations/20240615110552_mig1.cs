        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlbumPrice = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackInUserPlaylists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrackInUserPlaylists_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackInUserPlaylists_UserPlaylists_UserPlaylistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackInUserPlaylists_TrackId",
                table: "TrackInUserPlaylists",
                column: "TrackId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackInUserPlaylists_UserPlaylistId",
                table: "TrackInUserPlaylists",
